...
module.exports = function 执行全套测试任务 ({
    ...
    return Promise.all([
        ...
        const 本工具集自身根文件夹之完整路径 = 路径工具.resolve(路径工具.dirname(本工具集自身_packageJSON_之完整路径))
        ...
        if (视作须为其安装本工具集的_npm_项目的_packageJSON_的完整路径 !== 本工具集自身_packageJSON_之完整路径) {
            文件系统工具之扩展版.copyFileSync(本工具集自身_packageJSON_之完整路径, 视作须为其安装本工具集的_npm_项目的_packageJSON_的完整路径)
        }
        ...
        // 应开启调试功能 && console.debug('\n 视作须为其安装本工具集的_npm_项目的_packageJSON', 视作须为其安装本工具集的_npm_项目的_packageJSON, '\n')
        ...
        // 应开启调试功能 && console.debug('\n @wulechuan/cli-scripts--npm-project-helpers 本工具集自身_packageJSON_之完整路径 \n   ', 本工具集自身_packageJSON_之完整路径, '\n')
        // 应开启调试功能 && console.debug('\n @wulechuan/cli-scripts--npm-project-helpers 视作须为其安装本工具集的_npm_项目的_packageJSON_的完整路径 \n   ', 视作须为其安装本工具集的_npm_项目的_packageJSON_的完整路径, '\n')
